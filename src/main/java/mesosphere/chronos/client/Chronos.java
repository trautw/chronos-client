...
import mesosphere.chronos.client.model.v2.App;
import mesosphere.chronos.client.model.v2.DeleteAppTaskResponse;
import mesosphere.chronos.client.model.v2.DeleteAppTasksResponse;
import mesosphere.chronos.client.model.v2.Deployment;
import mesosphere.chronos.client.model.v2.GetAppResponse;
import mesosphere.chronos.client.model.v2.GetAppTasksResponse;
import mesosphere.chronos.client.model.v2.GetAppsResponse;
import mesosphere.chronos.client.model.v2.GetEventSubscriptionRegisterResponse;
import mesosphere.chronos.client.model.v2.GetEventSubscriptionsResponse;
import mesosphere.chronos.client.model.v2.GetServerInfoResponse;
import mesosphere.chronos.client.model.v2.GetTasksResponse;
import mesosphere.chronos.client.model.v2.Group;
import mesosphere.chronos.client.model.v2.Result;
...
public interface Chronos {
	...
	GetAppResponse getApp(@Named("id") String id) throws ChronosException;
	...
	App createApp(App app) throws ChronosException;
	...
	Result deleteApp(@Named("id") String id) throws ChronosException;
	...
	Result createGroup(Group group) throws ChronosException;
	
	@RequestLine("DELETE /v2/groups/{id}")
	Result deleteGroup(@Named("id") String id) throws ChronosException;
	
	@RequestLine("GET /v2/groups/{id}")
	Group getGroup(@Named("id") String id) throws ChronosException;
